...
if (isset($_POST["Submit"])) {
    ...
    if (empty($coursename) || empty($coursetime) || empty($coursedetails) || empty($gender)) {
        ...
        $insert = "INSERT INTO coursedetails1(coursename,coursedetail,coursetype,coursetime,bgimage) VALUES('$coursename','$coursedetails','$gender','$coursetime','$folder')";
        ...
        <div style="margin-top: -100px;" class="dash-content">
            ...
            <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" autocomplete="off" require>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Course Details</label>
                    <input type="text" name="details" class="form-control" id="exampleInputEmail1" autocomplete="off" require>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Course Compelete Time</label>
                    <input type="text" name="time" class="form-control" id="exampleInputEmail1" autocomplete="off" require>
                </div>
                <div class="mb-3">
                    <label for="formFile" class="form-label">BG Image</label>
                    <input class="form-control" type="file" name="bgimage" id="formFile">
                </div>
                <br>
                ...
                <br>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" value="both" id="flexRadioDefault2" checked>
