...
$select = "SELECT * FROM coursedetails1";
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Course Compelete Time</th>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            echo "<tr>
                                    <td><img style='width: 200px;height:200px;' src=".$row["bgimage"]."></td>
                                    <td>".$row["coursename"]."</td>
                                    <td>".$row["coursedetail"]."</td>
                                    <td>".$row["coursetime"]."</td>
                                    <td>".$row["coursetype"]."</td>
                                    <td>
                                    <a href='updatecourse.php?id=$row[id]'><button type='button' class='btn btn-primary'>Update</button></a>
                                    <a href='deletecourse.php?name=$row[coursename]'><button type='button' class='btn btn-danger'>Delete</button></a>
                                    </td>
                                    <td>
                                    <a href='addexercises.php?id=$row[id]'><i class='fa-solid fa-square-plus fa-2x' style='color: #3477ea;'></i></a>
                                    </td>
                            </tr>";
                        }
                        ?>
